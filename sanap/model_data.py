...
Q = {
    ...
    'development_phase': 'From the national perspective, what has been the involvement of stakeholders in the development phase of the adaptation policy process?',
    'implementation_phase': 'From the national perspective, what has been the involvement of stakeholders in the implementation phase of the adaptation policy process?',
    'monitor_evaluate_phase': 'From the national perspective, what has been the involvement of stakeholders in the monitoring and evaluation of the adaptation policy process?',
